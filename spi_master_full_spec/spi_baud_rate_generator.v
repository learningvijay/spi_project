...
module spi_baud_rate_generator(
    ...
    output wire [12:0]spi_baud_rate_divisor
);
...
always@(posedge p_clk or negedge p_reset) begin
    ...
    else if(((spi_mode==2'b00)||(spi_mode==2'b01))&&(!ss)&&(!spiswai)&&(spi_baud_rate_divisor>12'd2))begin
...
always@(posedge p_clk or negedge p_reset) begin
    if (!p_reset) begin
        ...
        if((s_clk==1'b1)&&(count==((spi_baud_rate_divisor/2)-1))&&(cpol!=cpha)) begin
