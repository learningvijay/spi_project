...
initial begin
   ...
   setup_and_check(1'b0,1'b0,1'b0,1'b0,1'b0);
    ...
    #500000;
     ...
     p_reset=1'b1;
    #500000;
      setup_and_check(1'b0,1'b0,1'b0,1'b1,1'b0);
        #1000;
     p_reset=1'b1;
    #500000;
